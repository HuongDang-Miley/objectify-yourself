...
myCodeImmersivesObj.objectify = 'Miley'
...
myObject.address = [].push('Midtown', 'Manhattan', 'NY')
...
const func = function(keyName) {
  Object.defineProperty(newObject, keyName, {value : "overwritten DYNAMICALLY"});
 return newObject
}

let test = func('fingers');
test;
